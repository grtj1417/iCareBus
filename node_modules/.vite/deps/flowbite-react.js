...
import {
  ...
  HiSun,
  HiX
} from "./chunk-UYGRKRZI.js";
import {
  FaBars
} from "./chunk-CVHJCPTI.js";
import "./chunk-277MTXRP.js";
import {
  __commonJS,
  __toESM,
  require_react
...
var Progress = ({
  ...
  return (0, import_jsx_runtime64.jsx)(import_jsx_runtime64.Fragment, { children: (0, import_jsx_runtime64.jsxs)("div", { id, "aria-label": textLabel, "aria-valuenow": progress, role: "progressbar", ...props, children: [
    ...
    (0, import_jsx_runtime64.jsx)("div", { className: twMerge(theme2.base, theme2.size[size3], className), children: (0, import_jsx_runtime64.jsxs)("div", { style: { width: `${progress}%` }, className: twMerge(theme2.bar, theme2.color[color], theme2.size[size3]), children: [
